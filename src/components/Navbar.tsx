...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const handleOpenAlertModal = () => {
    ...
    window.history.pushState({ modalOpen: 'headerAlertModal', tab: activeTab, ticker: selectedTicker }, '');
  };
  ...
  const navItems = [
    ...
    { id: 'surge_cycle', label: 'محرك دورات الصعود (المحركات الـ 5)', icon: Flame },
