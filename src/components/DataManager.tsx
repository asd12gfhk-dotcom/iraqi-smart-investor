    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="bg-white border border-zinc-200 rounded-2xl p-5 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-4 py-2 bg-gradient-to-r from-amber-600 to-amber-700 text-white font-bold rounded-lg text-xs flex items-center gap-2 shadow-xs hover:from-amber-700 hover:to-amber-800 transition-all cursor-pointer shrink-0"
        >
          <RefreshCw className="w-4 h-4" />
          <span>تحديث بيانات الجلسة الحالية</span>
        </button>
      </div>
